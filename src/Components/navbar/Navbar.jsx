        ...
        <nav className='bg-transparent z-10 fixed m-auto w-[100%]'>
            <div className=' flex max-w-[1240px] m-auto justify-between items-center p-4 '>
                ...
                <ul className='hidden md:flex justify-between font-Montserrat text-[16px] items-center text-white'>
                    ...
                    <li className='mx-3 '><button className='bg-white text-black rounded-full py-2 px-4 text-black-200'>Contact us</button></li>
                </ul>
                <div className='w-[30px] flex md:hidden' onClick={handleNav}>
                    <img src={menu}></img>
                </div>
                <div className={nav ? 'bg-[#243ac7] flex-col md:hidden top-0 right-0 fixed w-[30%] h-full z-[-10] ease-in-out duration-700': 'bg-[#af7ecd] flex-col top-0 right-[-100%] fixed h-full z-[-10] ease-linear duration-1000 md:hidden'}>
                    ...
                    <ul className=' justify-between font-sans text-[16px] items-center mx-8 text-white'>
                        ...
                        <li className='my-6 '><button className='bg-white text-black rounded-full py-3 px-5 text-black-200'>Contact us</button></li>
                    </ul>
                </div>
            </div>
        </nav>
